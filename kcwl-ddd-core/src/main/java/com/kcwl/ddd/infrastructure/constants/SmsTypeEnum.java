...
public enum SmsTypeEnum {
    ...
    SHIPPER_WEB_CHANGE_LOGIN_PWD_SIMS_VERILY(26, "发运web货主修改登录密码短信验证码"),
    SHIPPER_WEB_TRANSFER_VERILY(27, "发运web转账短信验证码"),
    SHIPPER_WEB_CHANGE_MOBILE_VERILY(28, "发运web货主修改用户手机号"),
    SHIPPER_WEB_DESTROY_SIMS_VERILY(29, "发运web货主注销用户短信验证码"),
    ...
    SHIPPER_APP_RESET_PASSWORD_VERILY(33, "发运APP用户重置密码短信验证码"),
    ...
    SERVICES_LOGIN_SIMS_VERILY(300, "综合服务端web用户登录短信验证码"),
    SERVICES_REGISTER_SIMS_VERILY(301, "综合服务端web用户注册短信验证码"),
    SERVICES_FORGOT_PASSWORD_SIMS_VERILY(302, "综合服务端web用户忘记密码短信验证码"),
    SERVICES_CHANGE_PASSWORD_SIMS_VERILY(303, "综合服务端web用户修改密码短信验证码"),
    SERVICES_CHANGE_MOBILE_SIMS_VERILY(304, "综合服务端web用户修改手机号短信验证码");
