...
class SM4
{
	 ...
	 static final int SM4_DECRYPT = 0;
	...
	private void swap(long[] sk, int i)
	{
	 ...
	 static final byte[] SBOX_TABLE = { (byte) 0xd6, (byte) 0x90, (byte) 0xe9, (byte) 0xfe,
	 ...
	 static final int[] CK = { 0x00070e15,0x1c232a31,0x383f464d,0x545b6269,
	...
	private byte[] padding(byte[] input, int mode)
	{
	 ...
	 void sm4SetKeyEnc(SM4_Context ctx, byte[] key) throws Exception
	{
		if (ctx == null) 
		{
	 ...
	 void sm4SetkeyDec(SM4_Context ctx, byte[] key) throws Exception
	{
		if (ctx == null) 
		{
			throw new Exception("ctx is null!");
	 ...
	 byte[] sm4CryptEcb(SM4_Context ctx, byte[] input) throws Exception
	{
		if (input == null) 
		{
	 ...
	 byte[] sm4CryptCbc(SM4_Context ctx, byte[] iv, byte[] input) throws Exception
	{
