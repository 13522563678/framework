...
@SuppressWarnings("AlibabaUndefineMagicConstant")
 class Util {
     ...
     * @return
     */
     static byte[] byteConvert32Bytes(BigInteger n) {
        byte[] tmpd;
        if (n == null) {
            return null;
        }
     ...
     * @return
     */
     static BigInteger byteConvertInteger(byte[] b) {
        if (b[0] < 0) {
     ...
     * @return
     */
     static String getHexString(byte[] bytes, boolean upperCase) {
     ...
     * @return 十进制数值
     */
     static int hexStringToAlgorism(String hex) {
        hex = hex.toUpperCase();
        int max = hex.length();
        int result = 0;
        for (int i = max; i > 0; i--) {
     ...
     */
     static String algorismToHexString(int algorism, int maxLength) {
        String result;
     ...
     * @return 十进制数值
     */
     static int binaryToAlgorism(String binary) {
